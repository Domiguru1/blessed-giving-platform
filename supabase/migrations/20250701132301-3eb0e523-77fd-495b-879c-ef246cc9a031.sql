...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_contributions_user_id ON public.contributions(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_contributions_created_at ON public.contributions(created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_roles_user_id ON public.user_roles(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_contact_messages_created_at ON public.contact_messages(created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_contact_messages_status ON public.contact_messages(status);
